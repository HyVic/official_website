...
import { serviceList } from "../utils/alldata";
const description =
  ref(`天成未来核心团队长期致力于作物遗传学及基因组学的服务。为作物研究工作提供丰富的生物学技术及信息学工具，
包括群体遗传学测序(重测序、外显子测序及SNP芯片)，转录调控测序(RNA-seq、BSR)，表观组学研究(甲基化)，数据库开发等服务。<\n>
同时，天成未来累积了多个物种的大规模突变库测序项目的经验，对于突变材料的准备、测序方案、数据分析及突变体数据库提供成熟的解决方案。`);
